...
public class AdminForm2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fsearch.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(fsearch, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(159, 159, 159)
        ...
        delete2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/delete_16x16.gif"))); // NOI18N
        ...
        update2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/update icon.png"))); // NOI18N
        ...
        add2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Add.png"))); // NOI18N
        add2.setText("ADD");
        ...
        setSize(new java.awt.Dimension(468, 615));
    ...
    private void delete2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete2ActionPerformed
        ...
        try {
            ...
            ps.setString(1,fsearch.getText());
            ps.executeUpdate();
            conn.close();
            JOptionPane.showMessageDialog(add2, "Data Saved Successfully");
        }
    ...
    private void add2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add2ActionPerformed
       Connection conn=null;
        ...
        try {
            conn =   (Connection) DriverManager.getConnection("jdbc:postgresql://localhost:5432/UNIVERSITY","postgres","1234");
            ps = conn.prepareStatement("insert into faculty values(?,?,?,?,?,?,?,?)");
    ...
    private void update2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update2ActionPerformed
        ...
        try{
        conn = (Connection) DriverManager.getConnection("jdbc:postgresql://localhost:5432/UNIVERSITY","postgres","1234");
        ps = conn.prepareStatement("update faculty set faculty_id=?,faculty_name=?,age=?,mob_no=?,dob=?,gender=?,f_pass=?,d_id=? where faculty_id=?");
        ps.setString(1,id2.getText());
        ps.setString(2,name.getText());
        ps.setInt(3,Integer.parseInt(age.getText()));
        ps.setString(4,contact.getText());
        ...
        ps.setString(7,pass.getText());
        ps.setInt(8,Integer.parseInt(dep.getText()));
        ps.setString(9,fsearch.getText());
        ps.executeUpdate();
        conn.close();
        }
        catch(SQLException ex) {
